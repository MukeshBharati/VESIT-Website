<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <div class="float-right" id="searchToggle">
    ...
    <div class="col-md-3 col-lg-2 col-sm-2 py-3">
            <ul class="nav flex-column vesitsidebar" style="height:100%; overflow:hidden;">
                <li class="nav-item py-2 my-2 ">
                    <a id="id1" class="nav-link" href="../Views/SORT.html">Social Responsibility</a>
                </li>
                <li class="nav-item py-2 my-2">
                    <a id="id2" class="nav-link" href="../Views/cultural.html" onclick="window.location.href='./Views/cultural.html'; window.location.reload();">Cultural</a>
                </li>
                <li class="nav-item py-2 my-2">
                    <a id="id3" class="nav-link" href="../Views/music.html">Music</a>
                </li>
                <li class="nav-item py-2 my-2">
                    <a id="id4" class="nav-link" href="../Views/sports.html" onclick="window.location.href='../Views/sports.html'; window.location.reload();">Sports</a>
                </li>
                <li class="nav-item py-2 my-2">
                    <a id="id5" class="nav-link" href="../Views/photo_circle.html">VESIT Photo Circle</a>
                </li>
                <li class="nav-item py-2 my-2">
                    <a id="id5" class="nav-link" href="../Views/student_achievements.html">Student Achievements</a>
                </li>
        ...
        <div id="sports" style="display: none" class="m-3">
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                    ...
                    <ul><a href="cricket.html">Cricket</a></ul>
                    <ul>Football</ul>
                    <ul>Hand Ball</ul>
                    <ul>Kabaddi</ul>
                    <br>
