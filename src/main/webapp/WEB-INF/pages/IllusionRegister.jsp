...
<head>
    ...
    <title>Illusion Registration</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="container">
        <h1 class="text-center mb-4">Illusion Registration</h1>
        <form:form action="${pageContext.request.contextPath}/user/illusionreg" method="post" modelAttribute="cultural">
            ...
            <form:hidden path="culturalType" value="Illusion"/>
