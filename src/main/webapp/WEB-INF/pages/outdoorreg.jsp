...
<body>
    <div class="container">
        ...
        <form:form action="${pageContext.request.contextPath}/user/outreg" method="post" modelAttribute="user" onsubmit="return validateForm()">
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="game">Select Game</label>
            <form:select path="game" class="form-control" id="game" required="true">
                <form:option value="" label="Select a game"/>
                <form:option value="cricket" label="Cricket"/>
                <form:option value="football" label="Football"/>
                <form:option value="handball" label="Handball"/>
                <form:option value="badminton" label="Badminton"/>
                <form:option value="kabaddi" label="Kabaddi"/>
            </form:select>
        </div>
        <button type="submit" class="btn btn-primary">Submit</button>
    </form:form>
