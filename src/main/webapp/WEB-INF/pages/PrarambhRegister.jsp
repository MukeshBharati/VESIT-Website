...
<head>
    ...
    <title>Prarambh Registration</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="container">
        <h1 class="text-center mb-4">Prarambh Registration</h1>
        <form:form action="${pageContext.request.contextPath}/user/prarambhreg" method="post" modelAttribute="cultural">
            ...
            <form:hidden path="culturalType" value="Prarambh"/>
