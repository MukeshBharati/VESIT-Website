<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value='/css/style1.css'/>">
        ...
        <link rel="stylesheet" href="M:\VesitWebsite1\VesitWebsite\src\main\webapp\css\app.css">
        <link rel="stylesheet" href="/VesitWebsite/src/main/webapp/css/style1.css">
...
.toast button {
    ...
    <body class="myClass">
        ...
        <div>
  <p>Registration status : ${savedStatus}
        </div>
        ...
        <div id="sports" style="display: none" class="m-3">
            ...
            <div class="tab-content" id="pills-tabContent">
              ...
              <!--  
                ...
                <script>
    // Call this function to display the toast notification
...
function showToast(message) {
    ...
    toast.innerHTML = message + '<button onclick="closeToast(this)">X</button>';
...
function closeToast(element) {
    var toast = element.parentElement;
    toast.classList.remove("show");
    // Remove toast from DOM after fade-out
    setTimeout(function() {
        toast.remove();
