...
<head>
    ...
    <title>Octaves Registration</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="container">
        <h1 class="text-center mb-4">Octaves Registration</h1>
        <form:form action="${pageContext.request.contextPath}/user/octavemusicsreg" method="post" modelAttribute="music">
            ...
            <form:hidden path="musicType" value="Ocatves"/>
