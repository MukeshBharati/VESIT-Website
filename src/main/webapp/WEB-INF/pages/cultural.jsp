...
<html lang="en"><head>
    ...
    <meta name="csrf-token" content="t13xnow5yqS3thVQXxR73DSL0oFIs6VH2lslRWOz">
    ...
    <link rel="stylesheet" href="https://vesit.ves.ac.in/css/app.css">
...
<div class="col-md-9 col-sm-8 main-content">
    ...
    <div class="m-3" id="disp" style="display: block;"><h1 class="container text-uppercase text-center pb-2">cultural</h1>
<hr style="
box-shadow:10px 10px 8px #888888;
">
                <div class="container">
        <div class="row"><h5 class="mx-auto  font-weight-bold font-italic">PRARAMBH</h5></div>
    <div class="row">
            <div class="col-md-3 ">
    ...
    <div class="row">
            <div class="col-md-3 ">
                <img src="https://vesit.ves.ac.in/storage/students_corner/extra_curricular/1576643265Cultural-Council-report-3-300x200.jpg" alt="" class="img-fluid pb-4">
            </div>
            <div class="col-md-9">
...
<p>The Illusion team extensively scouts the institution for 6 prudent and qualified team leaders who face each other to bring home the championship trophy. The teams work tirelessly to identify the most promising talents from the institution by a series of auditions and interviews, with the team leaders monitoring closely. A fierce auction sees the team leaders lock horns with each other in the battle to find the perfect medley of members for their team. The auction process results in the formation of 42 members in each team leaded by 6 formidable leaders in portfolios of Music, Dance, Drama, Literature, Visual Arts and Aesthetics. After a fierce competition one of the six teams emerges as the winner. With innovative events planned for each portfolio Illusion is certainly an event to remember for years</p>
        ...
        <div class="row">
            <div class="col-md-9 text-justify">
                <p>Shree Ganesha, our most awaited guest bestowed his blessings upon us. This festival is also celebrated in our college. After the Ganpati holidays, we continued the Ganpati celebrations by keeping a Ganesh MahaPujan in the library of VESIT. The cultural council joined hands in making Ganesh Chaturthi special by taking special efforts for making delicious prasad like Sheera, Sev-bundi for the entire VESIT family.</p>
            </div>
            <div class="col-md-3">
                <img src="https://vesit.ves.ac.in/storage/students_corner/extra_curricular/1576643305Cultural-Council-report-4-300x200.jpg" alt="" class="img-fluid">
            </div>
        </div>
    </div>
        </div>
                        <div class="container">
        <div class="row"><h5 class="mx-auto  font-weight-bold font-italic">UTSAV</h5></div>
    <div class="row">
            <div class="col-md-3 ">
                <img src="https://vesit.ves.ac.in/storage/students_corner/extra_curricular/1576643403Cultural-Council-report-6-300x200.jpg" alt="" class="img-fluid pb-4">
            </div>
            <div class="col-md-9">
                <p>Utsav is an annual college event conducted in March. In Utsav the events are conducted branch wise. These competitions are conducted for Juniors and Seniors separately. The Junior group consists of FE and SE while the Senior consists of TE and BE.</p>
...
<p>Utsav is the last cultural event wherein students showcase their talent and collect memories that they will cherish forever</p>
    ...
    <div id="sports" style="display: none" class="m-3">
        ...
        <ul class="heading nav nav-pills mb-3" id="pills-tab" role="tablist">
            <li class="nav-item">
                <a class="nav-link" onclick="changeURL(this.id)" id="overview-tab" data-toggle="pill" href="#overview" role="tab" aria-controls="overview" aria-selected="true">Overview</a>
            </li>
            <li class="nav-item">
