...
<head>
    ...
    <title>Udaan Registration</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="container">
        <h1 class="text-center mb-4">Udaan Registration</h1>
        <form:form action="${pageContext.request.contextPath}/user/udaanreg" method="post" modelAttribute="cultural">
            ...
            <form:hidden path="culturalType" value="Udaan"/>
